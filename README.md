...
- From folder `Friend_Management/`, run `make setup`
...
Creating babycrab_go_run ... done
?   	github.com/vinhnv1/babycrab	[no test files]
?   	github.com/vinhnv1/babycrab/config	[no test files]
...
PASS
ok  	github.com/vinhnv1/babycrab/internal/controllers	(cached)
...
--- PASS: TestRepository_IsExistedFriend (0.09s)
    ...
    --- PASS: TestRepository_IsExistedFriend/query_by_an_unknown_input_userIds_(empty) (0.04s)
...
--- PASS: TestRepository_IsBlockedFriend (0.10s)
...
--- PASS: TestRepository_GetFriendsByID (0.09s)
    ...
    --- PASS: TestRepository_GetFriendsByID/success_with_adding_input_of_userIds (0.05s)
...
--- PASS: TestRepository_GetUserBlocksByID (0.08s)
    --- PASS: TestRepository_GetUserBlocksByID/query_by_an_unknown_input_userIds_(empty) (0.04s)
    --- PASS: TestRepository_GetUserBlocksByID/success_with_adding_input_of_userIds (0.04s)
...
--- PASS: TestRepository_CreateSubscription (0.11s)
    --- PASS: TestRepository_CreateSubscription/success_with_adding_input_of_userIds (0.06s)
    --- PASS: TestRepository_CreateSubscription/query_by_an_unknown_input_userIds_(empty) (0.04s)
...
--- PASS: TestRepository_GetRecipientEmails (0.09s)
    --- PASS: TestRepository_GetRecipientEmails/query_by_an_unknown_input_userIds_(empty) (0.04s)
    --- PASS: TestRepository_GetRecipientEmails/success_with_adding_input_of_userIds (0.05s)
...
--- PASS: TestRepository_CreateUserBlock (0.08s)
    ...
    --- PASS: TestRepository_CreateUserBlock/query_by_an_unknown_input_userIds_(empty) (0.04s)
...
--- PASS: TestRepository_IsSubscribedFriend (0.08s)
    ...
    --- PASS: TestRepository_IsSubscribedFriend/query_by_an_unknown_input_userIds_(empty) (0.04s)
...
--- PASS: TestRepository_GetUserIDByEmail (0.08s)
    --- PASS: TestRepository_GetUserIDByEmail/success_with_adding_input_of_userIds (0.04s)
...
--- PASS: TestRepository_GetEmailsByUserIDs (0.08s)
    --- PASS: TestRepository_GetEmailsByUserIDs/query_by_an_unknown_input_userIds_(empty) (0.04s)
    --- PASS: TestRepository_GetEmailsByUserIDs/success_with_adding_input_of_userIds (0.04s)
PASS
ok  	github.com/vinhnv1/babycrab/internal/repository	(cached)

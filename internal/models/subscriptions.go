...
type Subscription struct {
	...
	SubscriptionRequestorID int `boil:"subscription_requestor_id" json:"subscription_requestor_id" toml:"subscription_requestor_id" yaml:"subscription_requestor_id"`
	SubscriptionTargetID    int `boil:"subscription_target_id" json:"subscription_target_id" toml:"subscription_target_id" yaml:"subscription_target_id"`
...
var SubscriptionColumns = struct {
	ID                      string
	SubscriptionRequestorID string
	SubscriptionTargetID    string
}{
	ID:                      "id",
	SubscriptionRequestorID: "subscription_requestor_id",
...
var SubscriptionTableColumns = struct {
	...
	ID:                      "subscriptions.id",
	SubscriptionRequestorID: "subscriptions.subscription_requestor_id",
	SubscriptionTargetID:    "subscriptions.subscription_target_id",
}
...
var SubscriptionWhere = struct {
	ID                      whereHelperint
	SubscriptionRequestorID whereHelperint
	SubscriptionTargetID    whereHelperint
}{
	ID:                      whereHelperint{field: "\"subscriptions\".\"id\""},
	SubscriptionRequestorID: whereHelperint{field: "\"subscriptions\".\"subscription_requestor_id\""},
	SubscriptionTargetID:    whereHelperint{field: "\"subscriptions\".\"subscription_target_id\""},
}

// SubscriptionRels is where relationship names are stored.
var SubscriptionRels = struct {
	SubscriptionRequestor string
	SubscriptionTarget    string
}{
	SubscriptionRequestor: "SubscriptionRequestor",
	SubscriptionTarget:    "SubscriptionTarget",
}

// subscriptionR is where relationships are stored.
type subscriptionR struct {
	SubscriptionRequestor *User `boil:"SubscriptionRequestor" json:"SubscriptionRequestor" toml:"SubscriptionRequestor" yaml:"SubscriptionRequestor"`
	SubscriptionTarget    *User `boil:"SubscriptionTarget" json:"SubscriptionTarget" toml:"SubscriptionTarget" yaml:"SubscriptionTarget"`
}
...
var (
	subscriptionAllColumns            = []string{"id", "subscription_requestor_id", "subscription_target_id"}
	subscriptionColumnsWithoutDefault = []string{"subscription_requestor_id", "subscription_target_id"}
...
// SubscriptionRequestor pointed to by the foreign key.
func (o *Subscription) SubscriptionRequestor(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id\" = ?", o.SubscriptionRequestorID),
	}
...
// SubscriptionTarget pointed to by the foreign key.
func (o *Subscription) SubscriptionTarget(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
		qm.Where("\"id\" = ?", o.SubscriptionTargetID),
	}
...
// LoadSubscriptionRequestor allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (subscriptionL) LoadSubscriptionRequestor(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSubscription interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args = append(args, object.SubscriptionRequestorID)
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if a == obj.SubscriptionRequestorID {
					continue Outer
				}
			}

			args = append(args, obj.SubscriptionRequestorID)
	...
	if singular {
		...
		object.R.SubscriptionRequestor = foreign
		if foreign.R == nil {
			foreign.R = &userR{}
		}
		foreign.R.SubscriptionRequestorSubscriptions = append(foreign.R.SubscriptionRequestorSubscriptions, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.SubscriptionRequestorID == foreign.ID {
				local.R.SubscriptionRequestor = foreign
				if foreign.R == nil {
					foreign.R = &userR{}
				}
				foreign.R.SubscriptionRequestorSubscriptions = append(foreign.R.SubscriptionRequestorSubscriptions, local)
				break
			}
		}
	}
...
// LoadSubscriptionTarget allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (subscriptionL) LoadSubscriptionTarget(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSubscription interface{}, mods queries.Applicator) error {
	var slice []*Subscription
	var object *Subscription
	...
	if singular {
		...
		args = append(args, object.SubscriptionTargetID)
	...
	Outer:
		for _, obj := range slice {
			...
			for _, a := range args {
				if a == obj.SubscriptionTargetID {
					continue Outer
				}
			}

			args = append(args, obj.SubscriptionTargetID)
	...
	if singular {
		foreign := resultSlice[0]
		object.R.SubscriptionTarget = foreign
		if foreign.R == nil {
			foreign.R = &userR{}
		}
		foreign.R.SubscriptionTargetSubscriptions = append(foreign.R.SubscriptionTargetSubscriptions, object)
		return nil
	}

	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.SubscriptionTargetID == foreign.ID {
				local.R.SubscriptionTarget = foreign
				if foreign.R == nil {
					foreign.R = &userR{}
				}
				foreign.R.SubscriptionTargetSubscriptions = append(foreign.R.SubscriptionTargetSubscriptions, local)
				break
			}
		}
	}
...
// SetSubscriptionRequestor of the subscription to the related item.
// Sets o.R.SubscriptionRequestor to related.
// Adds o to related.R.SubscriptionRequestorSubscriptions.
func (o *Subscription) SetSubscriptionRequestor(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	o.SubscriptionRequestorID = related.ID
	if o.R == nil {
		o.R = &subscriptionR{
			SubscriptionRequestor: related,
		}
	} else {
		o.R.SubscriptionRequestor = related
	}

	if related.R == nil {
		related.R = &userR{
			SubscriptionRequestorSubscriptions: SubscriptionSlice{o},
		}
	} else {
		related.R.SubscriptionRequestorSubscriptions = append(related.R.SubscriptionRequestorSubscriptions, o)
	}

	return nil
}

// SetSubscriptionTarget of the subscription to the related item.
// Sets o.R.SubscriptionTarget to related.
// Adds o to related.R.SubscriptionTargetSubscriptions.
func (o *Subscription) SetSubscriptionTarget(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	o.SubscriptionTargetID = related.ID
	if o.R == nil {
		o.R = &subscriptionR{
			SubscriptionTarget: related,
		}
	} else {
		o.R.SubscriptionTarget = related
	}

	if related.R == nil {
		related.R = &userR{
			SubscriptionTargetSubscriptions: SubscriptionSlice{o},
		}
	} else {
		related.R.SubscriptionTargetSubscriptions = append(related.R.SubscriptionTargetSubscriptions, o)
	}
